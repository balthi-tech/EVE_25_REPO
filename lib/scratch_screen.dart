...
import 'package:birthday_eve/main.dart';
import 'package:flutter/material.dart';

class ScratchCardScreen extends StatefulWidget {
  final ScratchPainter painter;

  const ScratchCardScreen({super.key, required this.painter});
...
class _ScratchCardScreenState extends State<ScratchCardScreen> {
  ...
  void resetScratch() {
    setState(() {
      ...
      widget.painter.revealed = false; // ✅ Painter reset
    });
  }
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: CustomPaint(painter: widget.painter..paths = paths),
              ),
            ),
            SizedBox(height: 50),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: Color(0xFFc91712),
...
class ScratchPainter extends CustomPainter {
  ...
  void paint(ui.Canvas canvas, Size size) {
    ...
    for (var p in paths) {
      canvas.drawCircle(p, scratchRadius, clear);
    }
    canvas.restore();
  }
